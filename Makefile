...
UNREALROOTPATH = /opt/ue/UnrealEngine-4.19
GAMEPROJECTFILE =/home/bruno.kindt/Library/projects/UE__Course/FPSGame/FPSGame.uproject
...
TARGETS = \
	...
	FPSGame-Linux-Debug  \
	FPSGame-Linux-DebugGame  \
	FPSGame-Linux-Shipping  \
	FPSGame-Linux-Test  \
	FPSGame \
	FPSGameEditor-Linux-Debug  \
	FPSGameEditor-Linux-DebugGame  \
	FPSGameEditor-Linux-Shipping  \
	FPSGameEditor-Linux-Test  \
	FPSGameEditor\
	configure
...
FPSGame-Linux-Debug:
	 $(PROJECTBUILD) FPSGame Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

FPSGame-Linux-DebugGame:
	 $(PROJECTBUILD) FPSGame Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

FPSGame-Linux-Shipping:
	 $(PROJECTBUILD) FPSGame Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

FPSGame-Linux-Test:
	 $(PROJECTBUILD) FPSGame Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

FPSGame:
	 $(PROJECTBUILD) FPSGame Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

FPSGameEditor-Linux-Debug:
	 $(PROJECTBUILD) FPSGameEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

FPSGameEditor-Linux-DebugGame:
	 $(PROJECTBUILD) FPSGameEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

FPSGameEditor-Linux-Shipping:
	 $(PROJECTBUILD) FPSGameEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

FPSGameEditor-Linux-Test:
	 $(PROJECTBUILD) FPSGameEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

FPSGameEditor:
	 $(PROJECTBUILD) FPSGameEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
